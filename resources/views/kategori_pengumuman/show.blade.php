...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-center">{{ __('Lihat Kategori Pengumuman') }}</div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="artikel" class="col-md-6 col-form-label text-md-left">{{ $kategori_pengumuman->updated_at->format('D, d M Y H:m') }}</label>
                    </div>

                    <div class="form-group row">
                        <label for="artikel" class="col-md-4 col-form-label text-md-right">Publisher</label>
                        <label for="artikel" class="col-md-6 col-form-label text-md-left">{{ $kategori_pengumuman->users_id }}</label>
                    </div>
